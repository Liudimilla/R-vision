/*Questao 19.8;Criar um vetor A e B com 10 elementos inteiros. Construir um vetor C ,onde
 cada elemento de C e multiplicaçao dos respcetivo elemento em A e B , ou seja C[i]= A[i]*B[i].
*/
package Exercer03;
