package Classer11;
public abstract class AbstractPess {

    //abstract; sig que nao pode ser instanciada.
    private String nome;
    ...
    public AbstractPess(String nome, String endereço, String telefone) {
        super();
        this.nome = nome;
    ...
    public abstract void bterEtiquetaEndereco();
